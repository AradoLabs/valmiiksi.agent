...
const hvacCompanyFromHämeenlinna = () => profiles.CompanyProfile(
    businessID = "11111",
    ...
    businessLineCodes = [43220],
    phoneNumbers = ["0401111111"],
    websites = ["http://example.com/hämeenlinna/hvac"],
    addresses = ["Street 1 H 12"],
    updated = new Date()
);
...
module.exports = {
    ...
    hvacCompanyFromHämeenlinna: hvacCompanyFromHämeenlinna
};
